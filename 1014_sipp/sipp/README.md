...
For high-performance stress testing, use our dedicated performance testing toolkit:

```bash
# Run basic performance test
./run_performance_test.sh basic

# Run high-concurrency stress test  
./run_performance_test.sh stress

# Run long-term stability test
./run_performance_test.sh stability

# Analyze test results
./run_performance_test.sh analyze
```

📖 **Detailed Guide**: [Performance Testing Documentation](./performance_testing/README.md)
...
sipp 10.18.1.239:5060         -sf "test_suite/scenarios/ims_call_uas.xml"         -oocsf "test_suite/scenarios/ims_default_response_temp.xml"         -inf "test_suite/config/uas_users.csv"         -i 10.18.2.12         -p 10000         -mp 50000         -t un         -r 500         -l 2000         -timeout 60         -nd         -fd 1         -trace_screen -screen_file "test_suite/logs/call_test/uas/uas_screen.log"         -trace_err -error_file "test_suite/logs/call_test/uas/uas_errors.log"


sipp 10.18.1.239:5060         -sf "test_suite/scenarios/ims_call_uac_register.xml"         -inf "test_suite/config/uac_users.csv"         -i 10.18.2.12         -p 12002         -t tn         -r 500         -l 2000         -timeout 60         -nd         -max_socket 4000         -fd 1         -trace_screen -screen_file "test_suite/logs/call_test/uac/uac_register_screen.log"         -trace_err -error_file "test_suite/logs/call_test/uac/uac_register_errors.log"


 sipp 10.18.1.239:5060         -sf "test_suite/scenarios/ims_call_uac.xml"         -inf "test_suite/config/uac_users.csv"         -i 10.18.2.12         -p 12002         -mp 52002         -t un         -r 100         -l 2000         -nd -aa         -max_socket 4000         -set call_hold_time 10000         -set call_again 1         -fd 1         -trace_screen -screen_file "test_suite/logs/call_test/uac/uac_screen.log"         -trace_err -error_file "test_suite/logs/call_test/uac/uac_errors.log"