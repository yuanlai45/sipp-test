...
*PLEASE* follow a few coding rules:
  ...
  - If possible, check that your changes can be compiled on:
      ...
      - FreeBSD.
# Case 1:
bash test_suite/scripts/ims_register_test.sh --scenario basic --local-ip 10.18.2.12 --remote-ip 10.18.1.239:5060 --initial-port 5060 --users 2 --rate 1 --duration 300 --reg-period 600000
